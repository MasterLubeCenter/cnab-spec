...
This repository holds multiple specifications in addition to several clarifying documents. The CNAB Core 1.0.0 specification is the main description of CNAB. Each specification moves on its own release cadence.
